...
class ProductControl extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view("UploadProduct", $type);
    }
    ...
    public function addproduct(){
        if(count($this->input->post()) > 0){
          ...
          //  $data['user_id'] = $this->Addtype->fetch_typeid($this->session->userdata('Id'));
    ...
    public function detepr()
    {
      


        $id = $this->input->get('product_id');
       $res= $this->ProductModel->delProduct( $id);
      // dd($res);
       
      if ($res) {
          echo "Product Deleted Succssfully";
    ...
    public function updatepr()
    {
        ...
        $id = $this->input->get('product_id');
       $res= $this->ProductModel->updateProduct( $id);
      // dd($res);
