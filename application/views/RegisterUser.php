                 ...
                 <form action='<?php echo base_url('register')?>' method="post">
                     <div class="input-group mb-3">
                         <input value="<?php if($this->session->flashdata('name')){
                            ...
                            oninvalid="setCustomValidity('Only Alphabets are allowed in name field')"  required>
                     ...
                     <div class="input-group mb-3">
                         <input value="<?php if($this->session->flashdata('mobile')){
                             echo $this->session->flashdata('mobile');} ?>" type="tel" class="form-control"
