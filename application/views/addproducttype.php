    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                        <form action="Addtype/addptype" method="post" class="row">
            <div class="col-md-10 col-12">
                ...
                <div class="col-4">
                    <button type="submit" name="addptype" class="btn btn-primary btn-block">Add Product Type</button>
                </div>
            </div>
        </form> <!-- /.card -->
                        </div>
         ...
         <tbody>
         <tr><?php foreach($type as $t){ ?>
                 <th scope="row"><?php echo $t->Id; ?></th>
                 <th scope="row"><?php echo $t->prod_type;?></th>
                 <td scope="row"><a href="deletedata?Id=<?php echo $t->Id; ?>">delete</td>
             </tr>
             <?php } ?>
         </tbody>
     </table>
