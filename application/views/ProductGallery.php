                                ...
                                <div class="card-body">
                                    <div>
                                            ...
                                            <div class="card-columns">
                                                ...
                                                ?>
                                                    <div class="card shadow-lg mx-1 " style="width: 18rem;">
                                                        <img class="card-img-top" src="uploads/<?php echo $row['product_image'] ?>" alt="Card image cap">
                                                        <div class="card-body">
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            ...
                                                            <input type="hidden" name="user_id" value="<?php echo $row['product_id']; ?>">
                                                            <div class=" card-body">
                                                                <a class="btn btn-primary" href="<?php echo base_url() ?>ProductControl/viewProducts">View
                                                                    Details</a>
                                                
                                                                <span class="span">
                                                                    <p class=" btn btn-warning">
                                                                    <?php $id= $row['product_id']; ?>
                                                                        <a  href="<?php echo base_url("updateprouct?product_id=$id");?>"  class="btn text-light">update</a>
                                                                    </p>
                                                                </span>
                                                                <span class="span">
                                                                <p class="card-text btn btn-danger card-link">
                                                                <?php $id= $row['product_id']; ?>
                                                                    <a href="<?php echo base_url("deleteprouct?product_id=$id");?>"  class="btn">delete</a>
                                                                </p>
                                                                </span>
                                                                <span class="span">
                                                                  <p class=" btn btn-success">
                                                                    <?php $id= $row['product_id']; ?>
                                                                    <a href="<?php echo base_url("invoice?product_id=$id");?>" class="btn">invoice</a>
                                                                </p>
                                                                </span>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination">
                                                <li class="page-item">
                                                    <a class="page-link" href='<?php echo base_url(); ?>productGallery?page=<?php echo --$page; ?>' aria-label="Previous">
                                                ...
                                                ?>
                                                <li class="page-item">
                                                    <a class="page-link" href='<?php echo base_url(); ?>productGallery?page=<?php echo $page++; ?>' aria-label="Next">
