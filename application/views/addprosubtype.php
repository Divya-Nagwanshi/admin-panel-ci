        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Add product subtype</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Add product subtype</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                <div class="col-md-12">
                                    <form action="addstype" method="post" class="row">

                                        <div class="form-group">

                                        <select class="selectpicker form-control"name="ty_id">
                            ...
                            <div class="col-md-10 col-12">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Product  Sub- Type" name="sub_name" required>

                                </div>
                                <div class="col-4">
                                    <button type="submit" name="submit" class="btn btn-primary btn-block">Add Product Subtype</button>
                                </div>
                            </div>
                            </form><!-- /.card -->
                        </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Product Subtype name</th>
                            ...
                            <tbody>
                                <tr><?php foreach ($subtype as $t) { ?>
                                        <th scope="row"><?php echo $t->sub_id; ?></th>
                                        <th scope="row"><?php echo $t->sub_name; ?></th>
                                        <th scope="row"><?php echo $t->ty_id; ?></th>

                                        <td scope="row"><a href="deletesdata?sub_id=<?php echo $t->sub_id; ?>">delete</td>
                                </tr>
                            <?php } ?>
