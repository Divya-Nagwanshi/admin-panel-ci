...
<body class="hold-transition sidebar-mini">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="<?php echo base_url('datatable'); ?>" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>Addtype" class="nav-link active">
   ...
   <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url('Email'); ?>" class="nav-link  active">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    MailBox
                                </p>
