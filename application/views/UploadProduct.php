                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>addProduct">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input <?php if (isset($product_name)) { ?> value="<?php echo $product_name;  ?>" <?php } ?> type="text" id="inputName" class="form-control" name="product_name" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <select class="selectpicker form-control" id="type_id" name="Id">
                                            <option value=""> Select Product Type </option>
                                            <?php foreach ($type as $t) {
                                            ?>
                                                <option value="<?php echo $t->Id; ?>"><?php echo $t->prod_type; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <br />
                                    <br />
                                    <label for="inputName">Product Sub-type</label>
                                    <div class="form-group">
                                        <select name="sub_id" id="sub_id" class="form-control input-lg">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor" name="product_desc" required><?php if (isset($product_desc)) {
                                                                                                echo $product_desc;
                                                                                            } ?>
                                        </textarea>
                                        <script>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="inputCost" class="form-control" name="product_cost" pattern="(^\d*\.?\d*[1-9]+\d*$)|(^[1-9]+\d*\.\d*$)" <?php if (isset($product_cost)) { ?> value="<?php echo $product_cost;  ?>" <?php } ?> min=1 oninvalid="setCustomValidation('Cost cannot be negetive')" required>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    <div class="form-group" id="x">
                                        <input type="file" <?php if (isset($image)) { ?> value="<?php echo $image;  ?>" onload="preview_image()" <?php } ?> name="image[]" id="uploadFile" class="" onchange="preview_image();" multiple required>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="submit" name="submit" value="Add new Product" class="btn btn-success float-right">
                        </div>
                    </div>
                </form>
            </section>
